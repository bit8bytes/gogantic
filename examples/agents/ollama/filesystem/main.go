...
// func (c OpenFile) Execute(ctx context.Context, input tools.Input) (tools.Output, error) {
// 	if input.Content == "" {
// 		return tools.Output{Content: ""}, errors.New(`please provide the filename in the Action Input: "filename"`)
// 	}

// 	content, err := os.ReadFile(input.Content)
// 	if err != nil {
// 		return tools.Output{Content: ""}, errors.New(err.Error())
// 	}

// 	response := "The content of the file is " + string(content)

// 	return tools.Output{Content: response}, nil
// }

// func (c WriteAndSaveToFile) Name() string { return "WriteAndSaveToFile" }

// func (c WriteAndSaveToFile) Execute(ctx context.Context, input tools.Input) (tools.Output, error) {
// 	fmt.Println(input)
...
// 			return tools.Output{}, errors.New(`please provide a valid JSON with "content" and "filename" fields for tools "WriteAndSaveToFile"`)
// 		}
// 	}

// 	if params.Filename == "" {
// 		return tools.Output{}, errors.New(`please provide the filename in the "filename" field`)
// 	}

// 	if params.Content == "" {
// 		return tools.Output{}, errors.New(`please provide content to write in the "content" field`)
// 	}
...
// 	return tools.Output{Content: fmt.Sprintf("Successfully wrote to %s", params.Filename)}, nil
// }
