...
func (c OpenFile) Call(ctx context.Context, input tools.Input) (tools.Output, error) {
	if input.Content == "" {
...
func (c WriteAndSaveToFile) Call(ctx context.Context, input tools.Input) (tools.Output, error) {
	fmt.Println(input)
