...
// func (t GetTemperatureInFahrenheit) Execute(ctx context.Context, input tools.Input) (tools.Output, error) {
...
// func (t FormatFahrenheitToCelsius) Execute(ctx context.Context, input tools.Input) (tools.Output, error) {
